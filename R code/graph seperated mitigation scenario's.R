...
df <- read_excel("C:/Rfiles/WB/CCDRKYR/KYRCCDR1/R code/Kyrgyz_all_scenarios_data3.xlsx")
...
scenarios <- c("Reformed", "Current", "Broiler", "Resilience")
...
color_palette <- c(
  "Broiler" = "#00A9E0",  # Red
  "Resilience" = "#006747",  # Yellow
  "Reformed" = "#FFB81C",  # Blue
  "Current" = "Black"   # Green
)

df <- df %>%
  mutate(Scenario = factor(Scenario, levels = c("Broiler", "Current", "Resilience", "Reformed"),
                           labels = c("Mitigation", "Current growth", "Resilient growth", "Reformed growth")))
...
df <- df %>%
  mutate(Scenario = factor(Scenario, levels = c("Broiler", "Current", "Reformed","Resilience",  "REF"),
                           labels = c("Mitigation", "Current growth", "Reformed growth","Resilient growth", "REF")))

color_palette <- c(
  "Mitigation" = "#00A9E0",  # Red
  "Resilient growth" = "#006747",  # Yellow
  "Reformed growth" = "#FFB81C",  # Blue
  "Current growth" = "Black"   # Green
)
...
ggsave("C:/Rfiles/WB/CCDRKYR/KYRCCDR1/Graphs/mitigationKYRnew.png", 
       ...
       height = 3.5,          # Height of the output image (in inches)
       dpi = 300)     
