...
scenarios <- c("Current", "Broiler", "Resilience")
...
df <- df %>%
  mutate(Scenario = factor(Scenario, levels = c("Broiler", "Current", "Resilience", "REF"),
                           labels = c("Mitigation", "Current growth", "Reformed growth", "REF")))
color_palette <- c(
  "Mitigation" = "#00A9E0",  # Red
  "Reformed growth" = "#FFB81C",  # Yellow
